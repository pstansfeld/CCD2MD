...
sys_opts.add_argument('-C',  '--conc',      help='A single float giving the concentration of NaCl in system - charge balance is maintained, Default = 0.15.', default = 0.15)
sys_opts.add_argument('-mp',  '--mempro',   help='Additional arguments for embedding the protein in the membrane using MemPrO/Insane4MemPrO. Add any additional arguments after this flag - default 5 grid points and 15 minimisation operations.', action='store_true')
...
if args.membrane:
    FuncConv.build_membrane_CG(ligands, PDBfile, args.outputfile, command_line, args.mempro, args.membrane, args.conc, newlipidome=args.newlipidome)
